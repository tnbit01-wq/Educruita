...
// Candidate layout with sidebar navigation
const CandidateLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Job Search', href: '/candidate/jobs', icon: BriefcaseIcon },
    { name: 'Applications', href: '/candidate/applications', icon: ClipboardDocumentCheckIcon },
    { name: 'Job Scam Checker', href: '/candidate/job-check', icon: ClipboardDocumentCheckIcon },
    { name: 'BGV Documents', href: '/candidate/bgv', icon: DocumentTextIcon },
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 bg-blue-600 rounded flex items-center justify-center text-white font-bold">J</div>
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-semibold text-gray-900 truncate w-32">{user?.full_name || 'User'}</p>
      ...
      <div className="lg:pl-64">
        ...
        <header className="bg-white shadow-sm border-b border-gray-200">
          <div className="flex items-center justify-between h-16 px-6">
            ...
            {/* Notifications */}
            <Link to="/candidate/notifications" className="relative p-2 text-gray-500 hover:text-gray-700">
