...
const FacultyLayout = () => {
    ...
    const navigation = [
        ...
        { name: 'Class Management', href: '/faculty/classes', icon: UsersIcon },
        { name: 'Leave Requests', href: '/faculty/leaves', icon: CalendarDaysIcon },
        { name: 'Student Feedback', href: '/faculty/feedback', icon: ChatBubbleLeftRightIcon },
        { name: 'Settings', href: '/faculty/settings', icon: Cog6ToothIcon },
    ];
            ...
            >
                <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
                    <div className="flex items-center">
                        ...
                        <h1 className="text-xl font-bold text-gray-900">Campus<span className="text-blue-600">Connect</span></h1>
                    </div>
                ...
                <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center">
                        <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-lg">
                            {(user?.full_name || user?.email || 'F').substring(0, 2).toUpperCase()}
                        </div>
                        <div className="ml-3">
                            <p className="text-sm font-semibold text-gray-900 truncate w-32">{user?.full_name || 'Faculty'}</p>
                            <p className="text-xs text-gray-500">Faculty • {user?.department || 'Member'}</p>
                        </div>
                    </div>
                </div>
